...
class JustWatchMyBridge extends BridgeAbstract
{
    const NAME = 'JustWatchMy';
    ...
    const PARAMETERS = [[
            ...
            'providers' => [
                ...
                'title' => 'Comma separated list of content provider ids. (check your cookies under jw/user/settings/providers)',
                'defaultValue' => 'aim,al4,bbc,dnp,itv,myf,nfx,plx'            
            ]
        ]
    ];
    ...
    {
        return 'https://www.justwatch.com/favicon.ico';
    }
}
